...
window.BMAP_AUTHENTIC_KEY = ""; (function() {
    ...
    z.lang.Ga.prototype.addEventListener = function(a, b, c) {
        if (z.lang.Js(b)) { ! b.Sk && (b.Sk = {}); ! this.vi && (this.vi = {});
            var e = this.vi,
            f;
    ...
    z.extend(tc.prototype, {
        ...
        hN: function(a) { ! a && 0 != a || (isNaN(a) || 0 > a) || (0 != a && (220 > a && (a = 220), 730 < a && (a = 730)), this.K.maxWidth = a)
        },
        Dc: function(a) {
            this.K.title = a
        },
    ...
    Hd.getTilesUrl = function(a, b, c) {
        ...
        console.log("http://localhost:7777/tiles/"+b+"/"+x+"/"+y+".png");
        return "http://localhost:7777/tiles/"+b+"/"+x+"/"+y+".png";
       /*  var e = a.x,
        a = a.y,
        f = Sb("normal"),
        g = 1,
    ...
    uf.prototype = {
        ...
        zP: function() { ! this.fh && (!this.Nk && !(this.Jl || this.Qx == this.Ob.offsetWidth * this.scale && this.ip == this.Ob.offsetHeight * this.scale)) && this.refresh()
        },
        iv: function(a) {
            var b;
        ...
        ga: function(a, b, c) { (b || this.Ob).addEventListener(a, this, !!c)
        },
        Zd: function(a, b, c) { (b || this.Ob).removeEventListener(a, this, !!c)
        },
        QB: ha(2),
        refresh: function() {
            var a, b, c, e = 0;
